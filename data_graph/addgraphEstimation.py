...
# plt.plot(arima_clarknet.y_pred.values[1:], color='red', label = 'arima')
# plt.plot(prophet_clarknet.y_pred.values[1:], color='green', label = 'prophet')

plt.plot(xlabel = 'datetime',ylabel ='request count', label='request count')
plt.plot(arima_nasa.y_pred.values[1:], color='red', label = 'arima')
plt.plot(prophet_nasa.y_pred.values[1:], color='green', label = 'prophet')
